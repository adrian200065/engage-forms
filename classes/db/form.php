...
/**
 * DB abstraction for form configs -- DON'T use directly. Use Engage_Forms_Forms class
 *
 ...
 */
class Engage_Forms_DB_Form extends Engage_Forms_DB_Base {
	 ...
	 * @since 1.5.3
	 *
	 * @var Engage_Forms_DB_Form
	 */
	protected static $instance;

	/**
	 * Engage_Forms_DB_Form constructor.
	 *
	 * @since 1.5.3
	 */
	 ...
	 */
 	public function update( array $data ){
		 ...
		 *
		 */
	    $save_revision = apply_filters( 'engage_forms_save_revision', true, $form_id );
