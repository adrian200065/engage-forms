 ...
 *
 * IMPORTANT: Should be created using Engage_Forms_Field_Synefactory::get_object()
 *
...
class Engage_Forms_Sync_Sync {
	...
	/**
	 * Engage_Forms_Field_Sync constructor.
	 *
	 * @since 1.5.0
	 *
	...
	public function __construct( array $form, array  $field, $field_base_id, $current_form_count = null ) {
		...
		add_filter( 'engage_forms_render_get_field', array( $this, 'reset_default' ), 25, 2 );
