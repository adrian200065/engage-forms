 ...
 */
class Engage_Forms_Render_Util {

	/**
	 * Array of  Engage_Forms_Render_Footer objects
	 *
	 * @since 1.5.0
	 *
	 * @var array
	...
	public static function notice_element_id( array  $form, $count ){
		 ...
		 * @param int $count Form instance count
		 */
		return apply_filters( 'engage_forms_render_notice_element_id', $element, $form, $count );
	...
	public static function form_id_attr( $current_form_count ){
		...
		$form_wrap_id = "engage-form_" . $current_form_count;
		return $form_wrap_id;
	}
	...
	public static function field_id_attribute( $current_form_count ){
		...
		//See: https://github.com/EngageWP/Engage-Forms/issues/1489
		_deprecated_function( 'Engage_Forms_Render_Util::field_id_attribute', 'Engage_Forms_Render_Util::form_id_attr', '1.5.0.8');
		$form_wrap_id = "engage-form_" . $current_form_count;
		return $form_wrap_id;
	}
	 ...
	 *
	 * Container/factory for Engage_Forms_Render_Footer objects
	 *
	 * @uses 1.5.0
	 *
	...
	public static function add_inline_data( $data, array $form ){
		...
		if( empty( self::$footer_objects[ $form[ 'ID' ] ] ) ){
			if ( is_array( $form ) ) {
				self::$footer_objects[ $form_id ] = new Engage_Forms_Render_Footer( $form );
			}
		}
		/** @var Engage_Forms_Render_Footer */
	 ...
	 *
	 * @return bool|Engage_Forms_Render_Footer
	 */
