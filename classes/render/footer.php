 ...
 *
 * Should be used through Engage_Forms_Render_Util::add_inline_data() which acts as factory, container for these objects, by form ID and a way to add to tracked objects.
 *
 ...
 */
class Engage_Forms_Render_Footer {
	...
	/**
	 * Engage_Forms_Render_Footer constructor.
	 *
	 * @since 1.5.0
	 *
	 * @param array $form
