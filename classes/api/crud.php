 ...
 */
abstract class Engage_Forms_API_CRUD implements Engage_Forms_API_Route
{
     ...
     * @since 1.5.0
     *
     * @var Engage_Forms_API_Form|Engage_Forms_API_Privacy
     */
    protected $form;
    ...
    {
        $error = new Engage_Forms_API_Error('not-implemented-yet',
            __('Route Not Yet Implemented :(', 'engage-forms'));
        return new Engage_Forms_API_Response($error, 501, array());
    }
    ...
    /**
     * Factory for Engage_Forms_API_Form objects
     *
     ...
     * @param bool $privacy_context Optional. If false, a Engage_Forms_API_Privacy is returned. If true, the default, a Engage_Forms_API_Form is returned.
     *
     * @return Engage_Forms_API_Form|Engage_Forms_API_Privacy
     * @throws Exception
     * @since 1.5.0
     *
     */
    protected function form_object_factory($id, WP_REST_Request $request, $set_prop = true, $privacy_context = false)
    {
        ...
        if ($privacy_context) {
            $obj = new Engage_Forms_API_Form($form);
        } else {
            $obj = new Engage_Forms_API_Privacy($form);
        }
