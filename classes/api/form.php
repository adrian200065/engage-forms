 ...
 */
class Engage_Forms_API_Form  implements  ArrayAccess {
	...
	/**
	 * Engage_Forms_API_Form constructor.
	 *
	 * @since 1.5.0
	 *
	...
	public function get_entry_list_fields(){
		$entry_list_fields = Engage_Forms_Forms::entry_list_fields( $this->form, true );
	...
	protected function set_fields(){
		$this->fields = Engage_Forms_Forms::get_fields( $this->form, true, true );
		if( ! empty( $this->fields ) ){
			foreach ( $this->fields as $field_id => $field ){
				 ...
				 */
				if( false == apply_filters( 'engage_forms_api_show_field', true, $field_id, $field, $this->form, $this->request ) ){
	...
	public function save_form(){
	    ...
	    Engage_Forms_Forms::save_form($this->form );
        return $this;
