...
/**
 * Mini EngageWP.com API client for feeds to admin
 *
...
class Engage_Forms_Admin_Feed {
	 ...
	 * @var string
	 */
	protected static  $api_url = 'https://engageforms.com/wp-json/engagewp_api/v2/';
	...
	protected static function get_data( $endpoint, $args = null ){
		...
		$key = md5( 'ef_feed' . $endpoint . EFCORE_VER );
	...
	/**
	 * Get Engage Forms add-on
	 *
	 * @since 1.4.2
	 *
	 * @return array|string
	 */
	public static function get_ef_addons(){
		return self::get_data( 'products/ef-addons', array( 'per_page' => 50 ) );
	}
	...
	protected static function prepare_item( $data ){
		if (   isset( $data->link )  ) {
			 ...
			 */
			$affiliate_id = apply_filters( 'engage_forms_affiliate_id', null );
