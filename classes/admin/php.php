 ...
 */
class Engage_Forms_Admin_PHP{

    /**
     * Minimum supported version of Engage Forms
     *
    ...
    /**
     * Minimum version of Engage Forms that is tested
     *
    ...
    /**
     * Is a version of PHP supported by Engage Forms?
     *
     * @since 1.6.0
     *
    ...
    /**
     * Is a version of PHP tested with Engage Forms?
     *
     * @since 1.6.0
     *
     * @param string|null $version Optional. PHP version to test. Default is current version of PHP.
    ...
    /**
     * Is a version of PHP's supported deprecated by Engage Forms?
     *
     * @since 1.6.0
     *
     * @param string|null $version Optional. PHP version to test. Default is current version of PHP.
    ...
    public static function get_deprecated_notice(){
        return sprintf('%s %s',
            esc_html__( sprintf('You are using a VERY out of date version of PHP: %s. Engage Forms 1.7 will require PHP Version %s or later.',
                PHP_VERSION, self::get_minimum_tested_version()
            ), 'engage-forms'),
            sprintf('<a style="color:#fff;" href="https://engageforms.com/php?utm_source=wp-admin&utm_campaign=php_deprecated" target="__blank">%s</a>',
