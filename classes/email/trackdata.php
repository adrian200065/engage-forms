 ...
 */
class Engage_Forms_Email_TrackData {
	...
	/**
	 * Engage_Forms_Email_TrackData constructor.
	 *
	 * @since 1.4.5
	 */
	...
	public function success(){
		$events = Engage_Forms_DB_Track::get_instance()->by_event( 'email_sent', false );
	...
	public function failed(){
		$events = Engage_Forms_DB_Track::get_instance()->by_event( 'email_failed', false );
