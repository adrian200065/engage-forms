...
abstract class Engage_Forms_CDN implements Engage_Forms_CDN_Contract{
	...
	/**
	 * Url for Engage Forms dir to be replaces
	 *
	 * @since 1.5.3
	 *
	 * @var string
	...
	public function add_hooks(){
		add_filter( 'engage_forms_script_urls', array( $this, 'filter_script_urls' ) );
		add_filter( 'engage_forms_style_urls', array( $this, 'filter_style_urls' ) );
	}
	...
	public function remove_hooks(){
		remove_filter( 'engage_forms_script_urls', array( $this, 'filter_script_urls' ) );
		remove_filter( 'engage_forms_style_urls', array( $this, 'filter_style_urls' ) );
	}

	/**
	 * Replace urls for scripts
	 *
	 * @uses "engage_forms_script_urls" filter
	 *
	 * @since 1.5.3
	 *
	 ...
	 *
	 * @uses "engage_forms_style_urls" filter
	 *
	 * @since 1.5.3
	 *
	 * @param array $urls Array of slug => url
	...
	protected function set_protocol(){
		 ...
		 */
		$this->protocol = apply_filters( 'engage_forms_cdn_protocol', $this->protocol );
	}
	...
	protected function set_cdn_version(){
		 ...
		 *
		 * If you have checked out Engage Forms from Github and are on master branch current version might not exist in CDN yet, setting to "latest" will pull latest form Github
		 *
		 * @since 1.5.3
		 */
		$this->cdn_version = apply_filters( 'engage_forms_cdn_version', $this->version );
	}
