...
/**
 * Entry token abstraction -- used for allowing ef_ee edits/ entry editor edits
 *
 ...
 */
class Engage_Forms_Entry_Token {
	/**
	 * Check a token
	 *
	 * @since 1.5.0.6
	...
	public static function verify_token( $test_token, $entry_id, $form_id ){
		$compare_token = self::make_test_token( $entry_id, Engage_Forms_Forms::get_form( $form_id ) );
	...
	public static function  create_entry_token( $entry_id, $form ){
		$details = Engage_Forms::get_entry_detail( $entry_id, $form );
