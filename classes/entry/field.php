...
/**
 * Object representation of an entry field - ef_form_entry_values
 *
 ...
 */
class Engage_Forms_Entry_Field  extends Engage_Forms_Entry_Object {
	 ...
	 *
	 * @return int|Engage_Forms_Entry_Field
	 */
	...
	public function save(){
		global  $wpdb;
		$wpdb->insert( $wpdb->prefix . 'ef_form_entry_values', $this->to_array() );
