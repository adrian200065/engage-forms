...
/**
 * Class Engage_Forms_Entry_Fields
 *
 * A collection of many field values, from different entries of the same form.
 */
class Engage_Forms_Entry_Fields implements \engagewp\EngageContainers\Interfaces\Arrayable
{
     ...
     * @since 1.7.0
     *
     * @var  Engage_Forms_Entry_Field[] $fields
     */
    protected $fields;
    /**
     * The form config
    ...
    /**
     * Engage_Forms_Entry_Fields constructor.
     * @param array $form Form configuration
     * @param Engage_Forms_Entry_Field[] $fields
     */
    ...
    public function get_field( $field_id ){
        ...
        throw new Exception( __( 'Field Not Found', 'engage-forms' ) );
    }
     ...
     * @since 1.7.0
     *
     * @param Engage_Forms_Entry_Field[] $fields  Entry field objects to add
     */
    protected function set_fields_form_array(array $fields){
        foreach ( $fields as $field ){
            $this->add_field( Engage_Forms_Entry_Factory::entry_field($field) );
        }
    }
