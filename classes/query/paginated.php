<?php
use \engagewp\EngageFormsQuery\Features\FeatureContainer as Queries;
...
/**
 * Class Engage_Forms_Query_Paginated
 *
 * Does paginated queries. Shows all values.
 */
class Engage_Forms_Query_Paginated implements Engage_Forms_Query_Paginates
{

    /**
     * EngageFormsQueries FeatureContainer
     *
     * @since 1.7.0
     *
     * @var Queries|null
    ...
    /**
     * Engage_Forms_Query_Paginated constructor.
     *
     * @since 1.7.0
     *
     * @param array $form The form configuration
     * @param Queries|null $queries Optional. Engage Forms Query Tool feature container. Default is null.
    ...
    {
        $this->queries = is_null($queries) ? \engagewp\EngageFormsQueries\EngageFormsQueries() : $queries;
        $this->form = $form;
    ...
    public function select_values_for_form( EntryValueSelect $entry_value_select )
    {
        ...
        $fields =  new Engage_Forms_Entry_Fields( $this->form, $results );
        return $fields;
    ...
    public function set_page($page)
    {
        ...
        $this->page = engage_forms_validate_number( $page, 1, 20000 );
        return $this;
    }
   ...
   protected function get_entry_ids_of_form(){
    ...
    {
        return Engage_Forms_Entry_Bulk::count($this->form[ 'ID' ] );
    }
