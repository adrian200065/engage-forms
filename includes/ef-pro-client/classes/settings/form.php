...
use engagewp\engageforms\pro\json_arrayable;
use engagewp\engageforms\pro\settings;
...
class form extends json_arrayable
{
	...
	public function should_send_local()
	{
		...
		if ( $_send_local === true ) {
			return apply_filters('engage_forms_pro_send_local', true, $this->form_id);
		} else {
			return apply_filters('engage_forms_pro_send_local',
	...
	{
		if ( empty($this->form) ) {
			$this->form = \Engage_Forms_Forms::get_form($this->form_id);
		}
		return $this->form;
	}
}
