...
use engagewp\engageforms\pro\api\log;
...
class container extends repository
{
	...
	/**
	 * Get the HTML to be used in Engage Forms Pro tab
	 *
	 * @since 1.0.0
	 *
	 * @return string
	...
	/**
	 * Set the HTML to be used in Engage Forms Pro tab
	 *
	 * @since 1.0.0
	 *
	 * @param $html
	...
	/**
	 * Set main instance of Engage_Forms_DB_Tables class
	 *
	 * @since 0.5.0
	 *
	 * @param \Engage_Forms_DB_Tables $DB_Tables
	 */
	public function set_tables(\Engage_Forms_DB_Tables $DB_Tables)
	{
		$this->set('tables', $DB_Tables);
	}

	/**
	 * Get main instance of Engage_Forms_DB_Tables class
	 *
	 * @since 0.5.0
	 *
	 * @return \Engage_Forms_DB_Tables
	 */
