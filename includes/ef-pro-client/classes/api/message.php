...
use engagewp\engageforms\pro\attachments\attachments;
use engagewp\engageforms\pro\container;
use engagewp\engageforms\pro\exceptions\Exception;
use engagewp\engageforms\pro\repository;
...
class message extends repository
{
	...
	{
		$e = new \Engage_Forms_Entry($form, $entry_id);
	...
	public function add_attachment($path)
	{
		if ( !file_exists($path) ) {
			...
			$this->items[ 'attachments' ][] = esc_url_raw(engage_forms_pro_file_request_url($path));
		}
