...
use engagewp\engageforms\pro\api\keys;
use engagewp\engageforms\pro\settings\form;
...
class settings extends repository
{
	 ...
	 * @var string
	 */
	protected $option_key = '_ef_pro_settings';
	 ...
	 * @var string
	 */
	protected static $_option_key = '_ef_pro_settings';
	...
	{
		$forms = [];
		$all_forms = \Engage_Forms_Forms::get_forms();
