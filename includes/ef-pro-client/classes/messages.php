...
use engagewp\engageforms\pro\exceptions\factory;


/**
 * Class messages
 *
 * CRUD for local DB records of EF Pro messages
 *
...
class messages
{
	 ...
	 * @since 0.0.1
	 *
	 * @param int $efp_id Message ID from app
	 ...
	 * @throws Exception
	 */
	public function create($efp_id, $hash, $entry_id = 0, $type = 'main')
	{
		...
		throw New Exception(__('Could not store message', 'engage-forms'));
	 ...
	 * @param int $value Value to search for efp_id|ID|entry_id
	...
	protected function get_by($field, $value, $type = null)
	{
		...
		throw new Exception(__('Could not find message.', 'engage-forms'));
