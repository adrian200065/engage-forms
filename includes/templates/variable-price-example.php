<?php
/**
 * Engage Forms - Variable pricing example
 *
 * @since 1.3.0
 *
...
return array (
	...
	'ef_version' => '1.8.0',
	'name' => __( 'Variable Price Example', 'engage-forms' ),
	'scroll_top' => 0,
		...
		array(
			...
			'fld_1316929' =>
				array(
					'ID' => 'fld_1316929',
					'type' => 'hidden',
					'label' => __( 'Value Big', 'engage-forms' ),
					'slug' => 'value_big',
					'conditions' =>
						array(
			...
			'fld_6796077' =>
				array(
					'ID' => 'fld_6796077',
					'type' => 'hidden',
					'label' => __( 'Value Small', 'engage-forms' ),
					'slug' => 'value_small',
					'conditions' =>
						array(
			...
			'fld_3993413' =>
				array(
					'ID' => 'fld_3993413',
					'type' => 'checkbox',
					'label' => __( 'Want Option 1?', 'engage-forms' ),
					'slug' => 'option_1',
					'conditions' =>
						array(
							'type' => '',
			...
			'fld_5161425' =>
				array(
					'ID' => 'fld_5161425',
					'type' => 'dropdown',
					'label' => __('Option 2 Type', 'engage-forms' ),
					'slug' => 'option_2',
					'conditions' =>
						array(
							'type' => '',
								...
								array(
									'opt1533135' =>
										array(
											'calc_value' => 'Big',
											'value' => 'Big',
											'label' => __( 'Big', 'engage-forms' ),
										),
									'opt1786217' =>
										array(
											'calc_value' => 'Small',
											'value' => 'Small',
											'label' => __( 'Small', 'engage-forms' ),
										),
								),
							'email_identifier' => 0,
							'personally_identifying' => 0,
