<?php
/**
 * Engage Forms - Registration form example.
 *
 * @since 1.3.0
 *
 * @package   Engage_Forms
 * @author    Josh Pollock <Adrian@engagewp.com>
 * @license   GPL-2.0+
 * @link
 * @copyright 2015 Josh Pollock for EngageWP LLC
 */
return array (
	'_last_updated' => 'Fri, 21 Aug 2015 20:42:39 +0000',
	'ID' => 'EF55d78d3e3624f',
	'name' => __( 'Registration Form', 'engage-forms' ),
	'description' => '',
	'db_support' => 1,
	'pinned' => 0,
	'hide_form' => 1,
		...
		array (
			'fld_1327818' =>
				array (
					'ID' => 'fld_1327818',
					'type' => 'toggle_switch',
					'label' => __( 'Number of People', 'engage-forms' ),
							...
							'option' =>
								array (
									'opt1186018' =>
										array (
											'value' => '',
											'label' => __( 'One', 'engage-forms' ),
										),
									'opt1400463' =>
										array (
											'value' => '',
											'label' => __( 'Two', 'engage-forms' ),
										),
									'opt1453751' =>
										array (
											'value' => '',
											'label' => __( 'Three', 'engage-forms' ),
										),
								),
						),
				),
			'fld_1812913' =>
				array (
					'ID' => 'fld_1812913',
					'type' => 'text',
					'label' => __( 'Person One Name', 'engage-forms' ),
			...
			'fld_7290902' =>
				array (
					'ID' => 'fld_7290902',
					'type' => 'email',
					'label' => __( 'Person One Email', 'engage-forms' ),
			...
			'fld_6900741' =>
				array (
					'ID' => 'fld_6900741',
					'type' => 'text',
					'label' => __( 'Person Two Name', 'engage-forms' ),
			...
			'fld_1561974' =>
				array (
					'ID' => 'fld_1561974',
					'type' => 'email',
					'label' => __( 'Person Two Email', 'engage-forms' ),
			...
			'fld_2458053' =>
				array (
					'ID' => 'fld_2458053',
					'type' => 'email',
					'label' => __( 'Person Three Email', 'engage-forms' ),
			...
			'fld_6241168' =>
				array (
					'ID' => 'fld_6241168',
					'type' => 'text',
					'label' => __( 'Person Three Name', 'engage-forms' ),
				...
				array (
					'con_9457156563497745' =>
						array (
							...
							'name' => __( 'Two People', 'engage-forms' ),
							'type' => 'show',
							'fields' =>
								array (
					...
					'con_4812944559945067' =>
						array (
							...
							'name' => __( 'Three People', 'engage-forms' ),
							'type' => 'show',
							'group' =>
								array (
									'rw1885912614213066' =>
	...
	'mailer' =>
		array (
			'enable_mailer' => 1,
			'sender_name' => __( 'Engage Forms Notification', 'engage-forms' ),
