<?php
 ...
 return array(
  ...
  'name' => __( 'Simple Booking Form', 'engage-forms' ),
  'scroll_top' => 1,
  'description' => '																												',
  ...
  array(
    ...
    array(
      'ID' => 'fld_2254781',
      'type' => 'phone_better',
      'label' => __( 'Mobile Number', 'engage-forms' ),
      'slug' => 'mobile_number',
      'conditions' => 
      array(
        'type' => '',
    ...
    array(
      'ID' => 'fld_9356744',
      'type' => 'text',
      'label' => __( 'Check in date', 'engage-forms' ),
      'slug' => 'check_in_date',
      'conditions' => 
      array(
        'type' => '',
    ...
    array(
      'ID' => 'fld_9099709',
      'type' => 'text',
      'label' => __( 'Check out date', 'engage-forms' ),
      'slug' => 'check_out_date',
      'conditions' => 
      array(
        'type' => '',
    ...
    array(
      'ID' => 'fld_6496615',
      'type' => 'number',
      'label' => __( 'Number of adults', 'engage-forms' ),
    ...
    array(
      'ID' => 'fld_5630664',
      'type' => 'number',
      'label' => __( 'Number of children', 'engage-forms' ),
    ...
    array(
      'ID' => 'fld_4089741',
      'type' => 'paragraph',
      'label' => __( 'Comments', 'engage-forms' ),
      'slug' => 'comments',
      'conditions' => 
      array(
        'type' => '',
  ...
  array(
    ...
    'recipients' => '',
    'bcc_to' => '',
    'email_subject' => __( 'Simple Booking Form', 'engage-forms' ),
