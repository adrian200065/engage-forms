 ...
 return array(
  ...
  'name' => __( 'Rate our service', 'engage-forms' ),
  'scroll_top' => 1,
  'description' => '														',
  ...
  array(
    ...
    array(
      'ID' => 'fld_9014900',
      'type' => 'text',
      'label' => __( 'Full Name', 'engage-forms' ),
      'slug' => 'full_name',
      'conditions' => 
      array(
        'type' => '',
    ...
    array(
      'ID' => 'fld_841260',
      'type' => 'star_rating',
      'label' => __( 'How would you rate your experience', 'engage-forms' ),
  ...
  array(
    'on_insert' => 1,
    'sender_name' => __( 'Rate our service', 'engage-forms' ),
    'sender_email' => 'myemail@email.com',
    'reply_to' => '',
    'email_type' => 'html',
    'recipients' => '',
    'bcc_to' => '',
    'email_subject' => __( 'Rate our service', 'engage-forms' ),
