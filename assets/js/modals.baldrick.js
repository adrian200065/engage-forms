			...
			if(triggers.data('modal') && wm_hasModal === false){
				...
				if(!jQuery('#' + modal_id + '_baldrickModal').length){
					...
					var modal = jQuery('<div>', {
							...
							"class"       : "engage-modal-wrap",
						}),
					//modalDialog = jQuery('<div>', {"class" : "modal-dialog"});
					modalBackdrop = jQuery('<div>', {"class" : "engage-backdrop"});
					modalContent = jQuery('<div>', {"class" : "engage-modal-body",id: modal_id + '_baldrickModalBody'});
					modalFooter = jQuery('<div>', {"class" : "engage-modal-footer",id: modal_id + '_baldrickModalFooter'});
					modalHeader = jQuery('<div>', {"class" : "engage-modal-title", id : modal_id + '_baldrickModalTitle'});
					modalCloser = jQuery('<a>', { "href" : "#close", "class":"engage-modal-closer", "data-dismiss":"modal", "aria-hidden":"true",id: modal_id + '_baldrickModalCloser'}).html('&times;');
