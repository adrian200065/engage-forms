/*! GENERATED SOURCE FILE engage-forms - v3.0.0 - 2022-03-22 */var resBaldrickTriggers;
 ...
 *
 * In general, access through EFState.events() not directly.
 *
 * @since 1.5.3
 *
 * @param state {EFState} State object to subscribe to
 * @constructor
 */
function EFEvents(state) {
	var events = {};
 ...
 * @constructor
 */
function EFState(formId, $ ){

	var
		self = this,
		fields = {},
		events = new EFEvents(this),
		unBound = {},
		fieldVals  = {},
		calcVals = {};
	...
	/**
	 * Accessor for the EFEvents object used for this state
	 *
	 * @since 1.5.3
	 *
...
/* =========================================================
 * bootstrap-efdatepicker.js
 * Repo: https://github.com/eternicode/bootstrap-efdatepicker/
 * Demo: http://eternicode.github.io/bootstrap-efdatepicker/
 * Docs: http://bootstrap-efdatepicker.readthedocs.org/
 * Forked from http://www.eyecon.ro/bootstrap-efdatepicker
 * =========================================================
...
(function($, undefined){
    ...
    var Datepicker = function(element, options){
        ...
        if (this.isInline){
            this.picker.addClass('efdatepicker-inline').appendTo(this.element);
        }
        else {
            this.picker.addClass('efdatepicker-dropdown dropdown-menu');
        }

        if (this.o.rtl){
            this.picker.addClass('efdatepicker-rtl');
        }
    ...
    Datepicker.prototype = {
        ...
        _buildEvents: function(){
            ...
            else if (this.element.is('div')){  // inline efdatepicker
                this.isInline = true;
            }
            else {
                this._events = [
            ...
            this._secondaryEvents = [
                ...
                [$(document), {
                    'mousedown touchstart': $.proxy(function(e){
                        // Clicked outside the efdatepicker, hide it
                        if (!(
        ...
        remove: function(){
            ...
            this._detachSecondaryEvents();
            this.picker.remove();
            delete this.element.data().efdatepicker;
            if (!this.isInput){
        ...
        _zero_utc_time: function(utc){
            return utc && new Date(Date.UTC(utc.getUTEFullYear(), utc.getUTCMonth(), utc.getUTCDate()));
        },
        ...
        place: function(){
            ...
            this.picker.removeClass(
                'efdatepicker-orient-top efdatepicker-orient-bottom '+
                'efdatepicker-orient-right efdatepicker-orient-left'
            );

            if (this.o.orientation.x !== 'auto'){
                this.picker.addClass('efdatepicker-orient-' + this.o.orientation.x);
            ...
            // edge, fudge it sideways
                ...
                // Default to left
                this.picker.addClass('efdatepicker-orient-left');
                if (offset.left < 0)
            ...
            this.picker.addClass('efdatepicker-orient-' + yorient);
            if (yorient === 'top')
                top += height;
            else
        ...
        fillDow: function(){
            ...
            if (this.o.calendarWeeks){
                ...
                html += cell;
                this.picker.find('.efdatepicker-days thead tr:first-child').prepend(cell);
            }
            while (dowCnt < this.o.weekStart + 7){
                html += '<th class="dow">'+dates[this.o.language].daysMin[(dowCnt++)%7]+'</th>';
            }
            html += '</tr>';
            this.picker.find('.efdatepicker-days thead').append(html);
        },
        ...
        fillMonths: function(){
            ...
            this.picker.find('.efdatepicker-months td').html(html);
        },
        ...
        getClassNames: function(date){
            var cls = [],
                year = this.viewDate.getUTEFullYear(),
                month = this.viewDate.getUTCMonth(),
                today = new Date();
            if (date.getUTEFullYear() < year || (date.getUTEFullYear() === year && date.getUTCMonth() < month)){
                cls.push('old');
            }
            else if (date.getUTEFullYear() > year || (date.getUTEFullYear() === year && date.getUTCMonth() > month)){
                cls.push('new');
            }
            ...
            if (this.o.todayHighlight &&
                date.getUTEFullYear() === today.getFullYear() &&
        ...
        fill: function(){
            var d = new Date(this.viewDate),
                year = d.getUTEFullYear(),
                month = d.getUTCMonth(),
                startYear = this.o.startDate !== -Infinity ? this.o.startDate.getUTEFullYear() : -Infinity,
                startMonth = this.o.startDate !== -Infinity ? this.o.startDate.getUTCMonth() : -Infinity,
                endYear = this.o.endDate !== Infinity ? this.o.endDate.getUTEFullYear() : Infinity,
                endMonth = this.o.endDate !== Infinity ? this.o.endDate.getUTCMonth() : Infinity,
                todaytxt = dates[this.o.language].today || dates['en'].today || '',
                cleartxt = dates[this.o.language].clear || dates['en'].clear || '',
                tooltip;
            this.picker.find('.efdatepicker-days thead th.efdatepicker-switch')
            ...
            var prevMonth = UTCDate(year, month-1, 28),
                day = DPGlobal.getDaysInMonth(prevMonth.getUTEFullYear(), prevMonth.getUTCMonth());
                ...
                if (prevMonth.getUTCDay() === this.o.weekStart){
                    ...
                    if (this.o.calendarWeeks){
                        ...
                        var
                            ...
                            yth = new Date(Number(yth = UTCDate(th.getUTEFullYear(), 0, 1)) + (7 + 4 - yth.getUTCDay())%7*864e5),
            ...
            this.picker.find('.efdatepicker-days tbody').empty().append(html.join(''));

            var months = this.picker.find('.efdatepicker-months')
                .find('th:eq(1)')
                .text(year)
                .end()
            ...
            var yearCont = this.picker.find('.efdatepicker-years')
                .find('th:eq(1)')
                .text(year + '-' + (year + 9))
                .end()
                .find('td');
        ...
        updateNavArrows: function(){
            ...
            switch (this.viewMode){
                case 0:
                    if (this.o.startDate !== -Infinity && year <= this.o.startDate.getUTEFullYear() && month <= this.o.startDate.getUTCMonth()){
                        this.picker.find('.prev').css({visibility: 'hidden'});
                    }
                    else {
                        this.picker.find('.prev').css({visibility: 'visible'});
                    }
                    if (this.o.endDate !== Infinity && year >= this.o.endDate.getUTEFullYear() && month >= this.o.endDate.getUTCMonth()){
                ...
                case 1:
                case 2:
                    if (this.o.startDate !== -Infinity && year <= this.o.startDate.getUTEFullYear()){
                        this.picker.find('.prev').css({visibility: 'hidden'});
                    }
                    else {
                        this.picker.find('.prev').css({visibility: 'visible'});
                    }
                    if (this.o.endDate !== Infinity && year >= this.o.endDate.getUTEFullYear()){
                        this.picker.find('.next').css({visibility: 'hidden'});
                    }
                    else {
                        this.picker.find('.next').css({visibility: 'visible'});
                    ...
                    case 'span':
                        if (!target.is('.disabled')){
                            ...
                            if (target.is('.month')){
                                ...
                                this.viewDate.setUTEFullYear(year);
                                this._trigger('changeYear', this.viewDate);
        ...
        showMode: function(dir){
            ...
            this.picker
                .find('>div')
                .hide()
                .filter('.efdatepicker-'+DPGlobal.modes[this.viewMode].clsName)
                .css('display', 'block');
            this.updateNavArrows();
        }
    };
    ...
    var DateRangePicker = function(element, options){
        ...
        $(this.inputs)
            .efdatepicker(options)
            .bind('changeDate', $.proxy(this.dateUpdated, this));

        this.pickers = $.map(this.inputs, function(i){
            return $(i).data('efdatepicker');
        });
        this.updateDates();
    };
    DateRangePicker.prototype = {
        ...
        dateUpdated: function(e){
            ...
            var dp = $(e.target).data('efdatepicker'),
    ...
    var old = $.fn.efdatepicker;
    $.fn.efdatepicker = function(option){
        var args = Array.apply(null, arguments);
        args.shift();
        var internal_return;
        this.each(function(){
            var $this = $(this),
                data = $this.data('efdatepicker'),
            ...
            if (!data){
                ...
                if ($this.is('.input-daterange') || opts.inputs){
                    ...
                    $this.data('efdatepicker', (data = new DateRangePicker(this, $.extend(opts, ropts))));
                }
                else {
                    $this.data('efdatepicker', (data = new Datepicker(this, opts)));
                }
            }
    ...
    var defaults = $.fn.efdatepicker.defaults = {
        autoclose: false,
        beforeShowDay: $.noop,
        calendarWeeks: false,
        clearBtn: false,
    ...
    var locale_opts = $.fn.efdatepicker.locale_opts = [
        'format',
        'rtl',
        'weekStart'
    ];
    $.fn.efdatepicker.Constructor = Datepicker;
    var dates = $.fn.efdatepicker.dates = {
        en: {
    ...
    var DPGlobal = {
        ...
        parseDate: function(date, format, language){
            ...
            if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(date)){
                ...
                return UTCDate(date.getUTEFullYear(), date.getUTCMonth(), date.getUTCDate(), 0, 0, 0);
            }
            ...
            var parsed = {},
                ...
                setters_map = {
                    yyyy: function(d,v){
                        return d.setUTEFullYear(v);
                    },
                    yy: function(d,v){
                        return d.setUTEFullYear(2000+v);
                    },
                    m: function(d,v){
                        if (isNaN(d))
                            return d;
        ...
        formatDate: function(date, format, language){
            ...
            var val = {
                ...
                yy: date.getUTEFullYear().toString().substring(2),
                yyyy: date.getUTEFullYear()
            };
        ...
        '<th colspan="5" class="efdatepicker-switch"></th>'+
    ...
    DPGlobal.template = '<div class="efdatepicker">'+
        '<div class="efdatepicker-days">'+
    ...
    $.fn.efdatepicker.DPGlobal = DPGlobal;


    /* DATEPICKER NO CONFLICT
     * =================== */

    $.fn.efdatepicker.noConflict = function(){
        $.fn.efdatepicker = old;
        return this;
    };
     ...
     * ================== */
    $(document).on(
        'focus.efdatepicker.data-api click.efdatepicker.data-api',
        '[data-provide="efdatepicker"]',
        function(e){
            var $this = $(this);
            if ($this.data('efdatepicker'))
                return;

            // component click requires us to explicitly show it
            e.preventDefault();
            $this.efdatepicker('show')
...
jQuery(document).on( 'ef.init', function(){
	toggle_button_init();
});
 ...
 * @constructor
 */
 function Engage_Forms_Field_Config( configs, $form, $, state ){
     var self = this;
     ...
     var $submits = $form.find(':submit, .ef-page-btn-next' );
    ...
    /**
     ...
     this.init = function(){
         ...
         setupInputMasks();
		 $( document ).on( 'ef.add', setupInputMasks );
	 };
     ...
     function handleValidationMarkup( valid, $field, message, extraClass ){
         ...
         if( ! valid ){
             $parent.addClass( 'has-error' ).append( '<span id="ef-error-'+ $field.attr('id') +'" class="help-block ' + extraClass +'">' + message  + '</span>' );
    ...
    function fieldIsOnCurrentPage($field) {
        return ! $field.closest('.engage-form-page').attr('aria-hidden');
    }
    ...
    function getFieldPage($field) {
        return $field.closest( '.engage-form-page' ).data( 'formpage' );
    }
    ...
    /**
     ...
     this.html = function ( fieldConfig ) {
		 ...
		 (function bind() {
             ...
             $(document).on('ef.pagenav ef.modal', templateSystem );
		 }());
    ...
    var rangeSliders = {};
     ...
     this.range_slider = function( field ){
         ...
         $(document).on('ef.pagenav ef.add ef.disable ef.modal', function () {
             var el = document.getElementById(field.id);
             if (null != el) {
     ...
     this.star_rating = function( field ){
         ...
         init();
         var updating = false;
        jQuery( document ).on('ef.add', function(){
     ...
     this.phone_better = function( field ){
         ...
         var isValid = true;
         var reset = function(){
             var error = document.getElementById( 'ef-error-'+ fieldId );
			 isValid = true;
             if( null != error ){
                 error.remove();
             }
         ...
         $(document).on('ef.pagenav ef.add ef.disable ef.modal', init );
         $(document).on('ef.add', function(){
           reset();
           validation();
         });

        //Run Phone_better field validation when a submit or next page button is clicked
       $('#' + field.form_id_attr + ' [data-page="next"], #' + field.form_id_attr + ' form.engage_forms_form [type="submit"]').click( function(e){
		 ...
		 $(document).on('ef.remove', function(event,obj){
      ...
      * @since 1.5.0
      *
      * @type {{validateCVC: Engage_Forms_Field_Config.creditCardUtil.validateCVC, validateExp: Engage_Forms_Field_Config.creditCardUtil.validateExp}}
      */
     this.creditCardUtil = {
	...
	this.calculation = function (fieldConfig) {
		...
		//Run on EF page change, field added, field removed or modal opened.
		$(document).on('ef.pagenav ef.add ef.remove ef.modal', function (e,obj) {
		    if( 'ef' == e.type && 'remove' === e.namespace && 'object' === typeof  obj && obj.hasOwnProperty('field' ) && obj.field === fieldConfig.id ){
