...
use engagewp\engageforms\ef2\Fields\FieldTypes\TextFieldType;
use engagewp\engageforms\ef2\Traits\ConvertsMimeTypes;
...
class RenderField implements RenderFieldContract
{
    ...
    public function render()
    {
        ...
        if (function_exists('wp_add_inline_script')) {
            wp_add_inline_script('ef-render',
                sprintf('window.ef2 = window.ef2 || {}; window.ef2.%1s = window.ef2.%2s || {fields:{}}; window.ef2.%3s.fields.%4s=%5s;',
        ...
        return sprintf('<div id="%s" class="ef2-field-wrapper" data-field-id="%s"></div>',
    ...
    {
        return sprintf('ef2-%s', $this->getFieldIdAttr());
    }
