<div class="engage-config-group">
	<label for="{{_id}}_element"><?php echo __('Element', 'engage-forms'); ?></label>
...
<div class="engage-config-group">
	<div class="engage-config-field">
		<label><input id="{{_id}}_fixed" type="checkbox" class="field-config" name="{{_name}}[fixed]" value="1" {{#if fixed}}checked="checked"{{/if}}> <?php echo __('Money Format', 'engage-forms'); ?></label>
	</div>
</div>

<div class="engage-config-group" id="{{_id}}_thousand_separator">
	<label for="{{_id}}_sep">
		<?php esc_html_e('Thousands Separator', 'engage-forms'); ?>
	</label>
	<div class="engage-config-field">
...
<div class="engage-config-group" id="{{_id}}_decimal_separator">
	<label for="{{_id}}_sep_decimal">
		<?php esc_html_e('Decimal Separator', 'engage-forms'); ?>
	</label>
	<div class="engage-config-field">
...
<div class="engage-config-group">
	<div class="engage-config-field">
		<label><input id="{{_id}}_manual" type="checkbox" class="field-config" name="{{_name}}[manual]" value="1" {{#if manual}}checked="checked"{{/if}}> <?php echo __('Manual Formula', 'engage-forms'); ?></label>
	</div>
</div>
<div id="{{_id}}_autobox">
	<div class="engage-config-group engage-config-group-full">
		...
		><?php echo __('Add Operator Group', 'engage-forms'); ?></button>
	</div>
	<br>
...
<div id="{{_id}}_manualbox" style="display:none;">
	...
	<p class="description"><?php echo __('Use %field_slug% as field value variables', 'engage-forms'); ?></p>
</div>
<br><br><br>
{{#script}}
//<script>
