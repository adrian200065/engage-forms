<script type="text/html" id="calculator-group-tmpl">
	...
	{{#if operator}}
		...
		<div class="engage-config-group engage-config-group-full calculation-group-connect calculation-group" style="text-align:center;">
	...
	{{else}}
		...
		<div class="engage-config-group engage-config-group-full calculation-group">
			<div class="calculation-group-lines">
				...
				<div class="calculation-group-line">
					...
					<select class="calculation-operator-field engage-field-bind" data-exclude="system" data-default="{{field}}" style="max-width:229px;width:229px;"></select>
...
jQuery(function($){
	...
	$('body').on('click', '.remove-operator-line', function(e){
		...
		var clicked = $(this),
			row = clicked.parent(),
			group = clicked.closest('.engage-config-group'),
