...
<div class="engage-config-group">
	<label><?php _e('Masked Input', 'engage-forms'); ?></label>
	<div class="engage-config-field">
...
<div id="{{_id}}_maskwrap">
	<div class="engage-config-group">
		<label><?php _e('Mask', 'engage-forms'); ?></label>
		<div class="engage-config-field">		
	...
	<div class="engage-config-group">
		...
		<ul>
			<li>9 : <?php _e('numeric', 'engage-forms'); ?></li>
			<li>a : <?php _e('alphabetical', 'engage-forms'); ?></li>
			<li>* : <?php _e('alphanumeric', 'engage-forms'); ?></li>
			<li>[9 | a | *] : <?php _e('optional', 'engage-forms'); ?></li>
			<li>{int | * | +} : <?php _e('length', 'engage-forms'); ?></li>
		</ul>
		<p class="description"><?php _e('Any length character only', 'engage-forms'); ?>: [a{*}]</p>
		<p class="description"><?php _e('Any length number only', 'engage-forms'); ?>: [9{*}]</p>
		<p class="description"><?php _e('email', 'engage-forms'); ?>: *{+}@*{2,}.*{2,}[.[a{2,}][.[a{2,}]]]</p>
