<div class="engage-config-group">
	<label for="{{_id}}editor">
        <?php esc_html_e('Content', 'engage-forms'); ?>
    </label>
</div>
...
<div class="engage-config-group">
        <label for="{{_id}}_show_in_summary">
			<?php echo esc_html__('Email Summary?', 'engage-forms' ); ?>
        </label>
        <div class="engage-config-field">
            ...
            >
				<?php echo esc_html__('HTML field content is not shown in emails. Check here to add this content to the {summary} magic tag.', 'engage-forms' ); ?>
            </p>
    </div>
</div>