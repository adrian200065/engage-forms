			...
			foreach($field['config']['option'] as $option_key=>$option){
                ...
                >
                            <input
                                ...
                                id="<?php echo esc_attr(Engage_Forms_Field_Util::opt_id_attr($field_id, $option_key)); ?>"
                                class="<?php echo $field_id . $req_class; ?>"
                                name="<?php echo esc_attr($field_name); ?>[<?php echo esc_attr($option_key); ?>]"
                                value="<?php echo esc_attr($option['value']); ?>"
                                <?php if (Engage_Forms_Field_Util::is_checked_option($option['value'], (array)$field_value)){ ?>checked="checked"<?php } ?>
                                data-type="checkbox"
