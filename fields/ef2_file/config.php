...
<div class="engage-config-group">
    ...
    <div class="engage-config-field">
        ...
        <p class="description" id="{{_id}}_allowed-desc">
            <?php echo esc_html__('Comma separated eg. jpg,pdf,txt', 'engage-forms'); ?>
        </p>
    </div>
</div>

<div class="engage-config-group">
    <label for="{{_id}}_max_upload"><?php echo esc_html__('Max Upload Size', 'engage-forms'); ?></label>
    <div class="engage-config-field">
        <input
                id="{{_id}}_max_upload"
                type="number"
        ...
        <p class="description" id="{{_id}}_max_upload-desc" >
            <?php echo esc_html__('Max file size in bytes. If 0, any file size is allowed.', 'engage-forms'); ?>
        </p>
    </div>
</div>
...
<div class="engage-config-group">
    ...
    <div class="engage-config-field">
        <label for="{{_id}}_use_image_previews"><input id="{{_id}}_use_image_previews" type="checkbox" class="field-config"
            ...
            <?php echo esc_html__('Use image previews', 'engage-forms'); ?>
        </label>
    </div>
</div>


<div class="engage-config-group" id="{{_id}}_previews_height_wrap">
    <label for="{{_id}}preview_height">
		<?php echo esc_html__('Image Preview Height', 'engage-forms'); ?>
    </label>
    <div class="engage-config-field">
        <input
...
<div class="engage-config-group" id="{{_id}}_previews_width_wrap">
    <label for="{{_id}}preview_width">
		<?php echo esc_html__('Image Preview Width', 'engage-forms'); ?>
    </label>
    <div class="engage-config-field">
        <input
