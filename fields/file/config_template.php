<div class="engage-config-group">
	...
	<div class="engage-config-field">
		<label for="{{_id}}_attach">
			...
			<?php esc_html_e('Attach to Mailer', 'engage-forms'); ?>
		</label>
	</div>
</div>
...
<div class="engage-config-group">
	...
	<div class="engage-config-field">
		<label for="{{_id}}_allow_multiple">
			...
			<?php esc_html_e('Allow Multiple', 'engage-forms'); ?>
		</label>
	</div>
</div>
...
<div class="engage-config-group" id="{{_id}}_allow_multiple_text_wrap">
	...
	<div class="engage-config-field">
		<label for="{{_id}}_allow_multiple_text">
			...
			<?php esc_html_e('Button Text', 'engage-forms'); ?>
		</label>
...
<div class="engage-config-group">
	<label for="{{_id}}_allowed">
		<?php esc_html_e('Allowed Types', 'engage-forms'); ?>
	</label>
	<div class="engage-config-field">
		<input
                id="{{_id}}_allowed"
		...
		<p class="description" id="{{_id}}_allowed-desc">
			<?php esc_html_e('Comma separated eg. jpg,pdf,txt', 'engage-forms'); ?>
		</p>
	</div>
</div>
