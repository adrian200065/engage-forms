...
$privacy_page_url = engage_forms_privacy_policy_page_url();

if( !empty( $field['config']['title_attr'] ) ) {
    $title_attribute = $field['config']['title_attr'];
}else{
    $title_attribute = __('Privacy Policy Page', 'engage-forms');
}
?>

<div class="checkbox-inline engage-forms-consent-field">
    ...
    <label for="<?php echo esc_attr( $field_id); ?>"
           class="engage-forms-gdpr-field-label"
    ...
    >
        ...
        ?>
        <p
            class="engage-forms-consent-field-agreement"
        >
        ...
        <a href="<?php echo esc_url( $privacy_page_url ); ?>"
           target="_blank"
            ...
            class="engage-forms-consent-field-linked_text"
            >
