...
/*<div class="engage-config-group">
	<label for="{{_id}}_pollyfill"><?php _e('Polyfill', 'engage-forms'); ?></label>
	<div class="engage-config-field">
		<label><input id="{{_id}}_pollyfill_check" type="checkbox" class="field-config" name="{{_name}}[pollyfill]" value="1" {{#if pollyfill}}checked="checked"{{/if}}><?php esc_html_e('Use only on old browsers.','engage-forms'); ?></label>
	</div>
</div>*/
?>
<div class="engage-config-group">
...
<div id="{{_id}}_style">
	<div class="engage-config-group">
		<label for="{{_id}}_trackcolor">
           <?php esc_html_e('Track', 'engage-forms'); ?>
        </label>
		<div class="engage-config-field">
	...
	<div class="engage-config-group">
		<label for="{{_id}}_handle">
           <?php esc_html_e('Handle', 'engage-forms'); ?>
        </label>
		<div class="engage-config-field">
...
<div class="engage-config-group">
	<label for="{{_id}}_step">
       <?php esc_html_e('Steps', 'engage-forms'); ?>
    </label>
	<div class="engage-config-field">
...
<div class="engage-config-group">
	<label for="{{_id}}_showval">
       <?php esc_html_e('Show Value', 'engage-forms'); ?>
    </label>
	<div class="engage-config-field">
...
<div class="engage-config-group">
	<label for="{{_id}}_prefix">
       <?php esc_html_e('Prefix', 'engage-forms'); ?>
    </label>
	<div class="engage-config-field">
...
<div class="engage-config-group">
	<label for="{{_id}}_suffix">
       <?php esc_html_e('Suffix', 'engage-forms'); ?>
    </label>
	<div class="engage-config-field">
