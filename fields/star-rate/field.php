...
$star_target = Engage_Forms_Field_Util::star_target( Engage_Forms_Field_Util::get_base_id( $field, null, $form ) );
...
?>
	...
	<script type="text/javascript">
		...
		window.addEventListener("load", function(){
			...
			jQuery( document ).on('ef.add', <?php echo $field_id; ?>_stars );
		});
	</script>
<?php
Engage_Forms_Render_Util::add_inline_data( ob_get_clean(), $form );
