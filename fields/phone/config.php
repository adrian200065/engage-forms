...
<div class="engage-config-group">
	<fieldset>
		<legend>
			<?php esc_html_e('Style', 'engage-forms'); ?>
		</legend>
	</fieldset>

	<div class="engage-config-field">
		<label for="{{_id}}_phone_type_local">
            <?php esc_html_e('Local', 'engage-forms'); ?>
        </label>
	...
	<div class="engage-config-field">
		<label for="{{_id}}_phone_type_international">
            <?php esc_html_e('International', 'engage-forms'); ?>
        </label>
	...
	<div class="engage-config-field">
		<label for="{{_id}}_phone_type_custom">
            ...
            <?php esc_html_e('Custom', 'engage-forms'); ?>
        </label>
		<p class="description">
			<label for="{{_id}}_custom" class="screen-reader-text">
				<?php esc_html_e( 'Custom Phone Number Format', 'engage-forms' ); ?>
			</label>
		...
		<p class="description" id="{{_id}}_phone_type_custom_desc">
            <?php esc_html_e('Use the digit 9 to indicate a number', 'engage-forms'); ?>
        </p>
	</div>
</div>
